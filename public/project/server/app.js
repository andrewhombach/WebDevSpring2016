module.exports = function(app, uuid, mongoose, db) {
    ...
    var userService = require("./services/user.service.server.js") (app, UserModel, ProjectModel, TaskModel);
    ...
    var messageService = require("./services/message.service.server.js") (app, MessageModel, ProjectModel);
